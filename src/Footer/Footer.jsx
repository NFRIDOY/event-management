...
export default function Footer() {
    return (
        ...
        //                 <Link to='/' className="link link-hover">Premium Conference Planning</Link>
        //                 <Link to='/' className="link link-hover">Tech Expo and Product Launch</Link>
        //                 <Link to='/' className="link link-hover">Sustainable Corporate Events</Link>
        //             </nav>
        //             <nav className="mx-auto">
